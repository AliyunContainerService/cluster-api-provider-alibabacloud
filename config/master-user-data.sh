...
kubeadm init --apiserver-bind-port 8443 --token 2iqzqm.85bs0x6miyx1nm7l --apiserver-cert-extra-sans=\$(curl -s http://100.100.100.200/latest/meta-data/hostname) --apiserver-cert-extra-sans=\$(curl -s http://100.100.100.200/latest/meta-data/private-ipv4) --apiserver-cert-extra-sans=\$(curl -s http://100.100.100.200/latest/meta-data/eipv4)  --pod-network-cidr=192.168.0.0/16 -v 6
