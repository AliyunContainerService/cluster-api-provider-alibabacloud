...
// Package v1beta1 contains API Schema definitions for the alibabacloudproviderconfig v1beta1 API group
// +k8s:openapi-gen=true
// +k8s:deepcopy-gen=package,register
// +k8s:conversion-gen=sigs.k8s.io/cluster-api-provider-alibabacloud/pkg/apis/alibabacloudproviderconfig
// +k8s:defaulter-gen=TypeMeta
// +groupName=alibabacloudproviderconfig.k8s.io
package v1beta1
...
var (
	...
	SchemeGroupVersion = schema.GroupVersion{Group: "alibabacloudproviderconfig.openshift.io", Version: "v1beta1"}
...
// ProviderSpecFromRawExtension unmarshals a raw extension into an AlibabaCloudMachineProviderSpec type
