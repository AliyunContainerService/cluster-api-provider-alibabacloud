...
// AlibabaCloudMachineProviderStatus is the type that will be embedded in a Machine.Status.ProviderStatus field.
// It contains AlibabaCloud-specific status information.
...
type AlibabaCloudMachineProviderCondition struct {
	...
	// +optional
	Reason AlibabaCloudMachineProviderConditionReason `json:"reason,omitempty"`
