...
func (in *AlibabaCloudMachineProviderConfig) DeepCopyInto(out *AlibabaCloudMachineProviderConfig) {
	*out = *in
	...
	if in.IAMInstanceProfile != nil {
		...
		*out = new(AlibabaCloudResourceReference)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.SecurityGroups != nil {
		...
		*out = make([]AlibabaCloudResourceReference, len(*in))
		for i := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AlibabaCloudResourceReference) DeepCopyInto(out *AlibabaCloudResourceReference) {
	*out = *in
	if in.ID != nil {
		in, out := &in.ID, &out.ID
		*out = new(string)
...
func (in *AlibabaCloudResourceReference) DeepCopy() *AlibabaCloudResourceReference {
	if in == nil {
		return nil
	}
	out := new(AlibabaCloudResourceReference)
